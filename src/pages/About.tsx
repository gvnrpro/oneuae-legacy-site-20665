        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <section className="mb-20 fade-in">
            <div className="grid md:grid-cols-5 gap-12">
              <div className="md:col-span-3 space-y-8">
                <div>
                  <p className="font-sans text-base md:text-lg text-foreground leading-relaxed font-light mb-6">
                ...
                <div className="pt-8 border-t border-border">
                  <h2 className="font-serif text-xl md:text-2xl font-medium text-foreground mb-2">Mission</h2>
                ...
                <div className="pt-8 border-t border-border">
                  <h2 className="font-serif text-xl md:text-2xl font-medium text-foreground mb-2">Vision</h2>
                  <div className="w-10 h-px bg-gold mb-4" />
                  <p className="font-sans text-sm md:text-base text-muted-foreground leading-relaxed font-light">
          ...
          <section className="mb-20 py-30 bg-cool-gray fade-in">
            <div className="max-w-4xl mx-auto px-8">
              <h2 className="font-serif text-2xl md:text-3xl font-medium text-center mb-16">Under the Patronage</h2>
              ...
              <div className="flex flex-col md:flex-row gap-12 items-center">
                ...
                <div className="flex-1">
                  <h3 className="font-serif text-xl md:text-2xl font-medium text-foreground mb-4 leading-snug">
          ...
          {/* Core Values */}
          <section className="mb-20 fade-in">
            <h2 className="font-serif text-2xl md:text-3xl font-medium text-center mb-16">Core values</h2>
            
            <div className="grid md:grid-cols-3 gap-12 md:gap-16 max-w-5xl mx-auto">
              <div className="text-center">
                <h3 className="font-serif text-lg md:text-xl font-medium text-foreground mb-3">Unity</h3>
              ...
              <div className="text-center">
                <h3 className="font-serif text-lg md:text-xl font-medium text-foreground mb-3">Vision</h3>
                <div className="w-10 h-px bg-gold mx-auto mb-4" />
                <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed font-light">
              ...
              <div className="text-center">
                <h3 className="font-serif text-lg md:text-xl font-medium text-foreground mb-3">Excellence</h3>
                <div className="w-10 h-px bg-gold mx-auto mb-4" />
                <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed font-light">
          ...
          <section className="py-30 bg-cool-gray fade-in">
            <div className="max-w-4xl mx-auto px-8">
              <h2 className="font-serif text-2xl md:text-3xl font-medium text-center mb-16">Selection process</h2>
              ...
              <div className="space-y-12">
                <div className="flex gap-8">
                  ...
                  <div>
                    <h3 className="font-serif text-lg md:text-xl font-medium text-foreground mb-2">Nomination</h3>
                    <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed font-light">
                ...
                <div className="flex gap-8">
                  ...
                  <div>
                    <h3 className="font-serif text-lg md:text-xl font-medium text-foreground mb-2">Expert review</h3>
                    <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed font-light">
                ...
                <div className="flex gap-8">
                  ...
                  <div>
                    <h3 className="font-serif text-lg md:text-xl font-medium text-foreground mb-2">Final selection</h3>
                    <p className="font-sans text-xs md:text-sm text-muted-foreground leading-relaxed font-light">
