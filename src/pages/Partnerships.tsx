        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-20 fade-in">
            ...
            <p className="font-sans text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed font-light">
              Partner with OneUAE Awards to showcase your commitment to excellence
            </p>
          </div>

          <section className="mb-20 fade-in">
            <h2 className="font-serif text-2xl font-medium text-center mb-12">Partnership tiers</h2>
            
            <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {tiers.map((tier, index) => (
                <div
                  key={index}
                  className="bg-background border border-gold p-8 text-center transition-colors duration-300 hover:border-gold/60"
                >
          ...
          <section className="py-30 bg-cool-gray fade-in">
            <div className="max-w-4xl mx-auto px-8">
              ...
              <p className="font-sans text-base text-muted-foreground text-center mb-12 font-light max-w-2xl mx-auto">
                For detailed information about partnership benefits and to discuss customized packages, 
                please submit an inquiry below.
              </p>
              <PartnershipForm />
            </div>
          </section>
